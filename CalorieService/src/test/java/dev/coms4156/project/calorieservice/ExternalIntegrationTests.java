...
/**
 * External integration tests that verify our code works with an out-of-process dependency
 * (Google Cloud Firestore SDK pointed at the Firestore Emulator).
 *
 * <p>Skips automatically when FIRESTORE_EMULATOR_HOST is not set.</p>
 */
@SpringBootTest
...
public class ExternalIntegrationTests {
  ...
  /**
   * Verifies Food add/get/delete against the emulator using the Firestore SDK client
   * configured to the emulator.
   */
  @Test
  ...
  /**
   * Verifies User add/get/delete against the emulator using the Firestore SDK client
   * configured to the emulator.
   */
  @Test
